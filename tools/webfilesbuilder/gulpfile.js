...
gulp.task('esprcmjsminify', function (cb) {
  pump([
        gulp.src('../../src/websrc/js/esprcm.js'),
        uglify(),
...
gulp.task("esprcmjsgz", ["esprcmjsminify"], function() {
...
gulp.task('esprcmjsgzh', ["esprcmjsgz"] , function() {
...
gulp.task('scripts-concat', ["esprcmjsgzh"], function() {
...
gulp.task('styles-concat', function() {
    return gulp.src(['../../src/websrc/3rdparty/css/bootstrap-3.3.7.min.css', '../../src/websrc/3rdparty/css/footable.bootstrap-3.1.6.min.css', '../../src/websrc/3rdparty/css/sidebar.css', '../../src/websrc/3rdparty/css/ion.rangeSlider.min.css','../../src/websrc/css/esprcm.css'])
        .pipe(concat({
            path: 'required.css',
            stat: {
                mode: 0666
